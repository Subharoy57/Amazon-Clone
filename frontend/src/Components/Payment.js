  ...
  const confirmPayment = async (e) => {
    ...
    try {
      ...
      if (result.paymentIntent.status === 'succeeded') {
        ...
        // Do not navigate to the home page if the payment fails
      }
    } catch (error) {
      console.warn(error);
      window.alert("Enter a valid card number. Please try again later.");  
      // Do not navigate to the home page if an error occurs
    }
  };
